...
from user.models import Student, Clazz,Major
...
class Paper(models.Model):
    ...
    course = models.ForeignKey(Course, verbose_name="考试课程", on_delete=models.CASCADE, default="")
    ...
    program_number = models.PositiveSmallIntegerField("多选题数", default=5)
