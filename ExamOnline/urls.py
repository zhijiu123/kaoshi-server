...
from exam.views import GradeListViewSet, ExamListViewSet, PracticeListViewSet,GradeRecordListViewSet
from question.views import ChoiceListViewSet, FillListViewSet, JudgeListViewSet, ProgramListViewSet,CourseListViewSet
from record.views import ChoiceRecordListViewSet, FillRecordListViewSet, JudgeRecordListViewSet, \
    ProgramRecordListViewSet
from user.views import RegisterViewSet, StudentViewSet, UpdatePwdApi, ClazzListViewSet,MajorLisViewSet,CollegeViewSet,CollegeMajorClazzViewSet

router = DefaultRouter()

# 配置exams的url
router.register(r'exams', ExamListViewSet)
router.register(r'college-major-clazzs', CollegeMajorClazzViewSet)
router.register(r'colleges', CollegeViewSet)
router.register(r'grades', GradeListViewSet)
router.register(r'grade-records', GradeRecordListViewSet)
...
router.register(r'majors', MajorLisViewSet)
